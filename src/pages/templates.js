...
const TemplatesPage = ({ location }) => (
  <div>
    ...
    <div style={{margin: '6rem 0'}}>
      <h2 style={{textAlign: 'center', fontSize: '2.5em', marginBottom: '1rem' }}>Beautiful Templates</h2>
      <p style={{textAlign: 'center', fontSize: '1.5em', fontWeight: '300' }}>Simple templates to get you started</p>
    </div>
    <div className="container">
      { ['','','','','', ''].map(() => <div className="template">
